    ...
    <div className="min-h-screen font-sans pt-24">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 px-4 sm:px-6 md:px-12 mt-10">
        ...
        <div className="flex-1 mt-3 md:mt-0 flex flex-col items-center">
          ...
          <div className="bg-[#eee1d1] rounded-3xl px-2 sm:px-4 md:px-6 py-2 flex justify-center items-end gap-3 sm:gap-6 md:gap-8 w-full max-w-[1200px] mx-auto min-h-[200px] sm:min-h-[280px] lg:min-h-[340px] overflow-hidden">
            {" "}
            <img
              alt="chef"
              src={chef3Image}
